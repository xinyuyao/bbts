...
bbts::ffnn_relu_dif::ffnn_relu_dif() {

  // set the names
  impl_name = "ffnn_relu_dif_cpu";
  ...
  fn = &ffnn_relu_dif::relu_diff;
}

size_t bbts::ffnn_relu_dif::get_complexity_hint(const bbts::ud_impl_t::tensor_params_t &params,
...
void bbts::ffnn_relu_dif::get_out_meta(const bbts::ud_impl_t::tensor_params_t &params,
                                            const bbts::ud_impl_t::meta_args_t &_in,
...
void bbts::ffnn_relu_dif::relu_diff(const bbts::ud_impl_t::tensor_params_t &params,
