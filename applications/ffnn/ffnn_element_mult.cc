...
bbts::ffnn_element_mult::ffnn_element_mult() {

  // set the names
  impl_name = "ffnn_element_mult_cpu";
  ...
  fn = &ffnn_element_mult::mult;
}

size_t bbts::ffnn_element_mult::get_complexity_hint(const bbts::ud_impl_t::tensor_params_t &params,
...
void bbts::ffnn_element_mult::get_out_meta(const bbts::ud_impl_t::tensor_params_t &params,
                                            const bbts::ud_impl_t::meta_args_t &_in,
...
void bbts::ffnn_element_mult::mult(const bbts::ud_impl_t::tensor_params_t &params,
